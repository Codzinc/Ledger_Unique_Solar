    ...
    try {
      ...
      const apiData = {
        ...
        tax_percentage: formData.tax_percentage || "0.00",
         // ✅ CORRECT FIELD NAMES - Backend ke hisab se
      advance_payment: formData.advance_payment || "0.00",  // ✅ Ye backend field hai
      total_payment: grandTotal.toFixed(2),                 // ✅ Ye backend field hai
      completion_payment: (
        grandTotal - (parseFloat(formData.advance_payment) || 0)
      ).toFixed(2),                                         // ✅ Ye backend field hai
