        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-[#d8f276] text-[#181829] rounded-lg hover:bg-[#181829] hover:text-[#d8f276] transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#181829]"></div>
              ) : (
