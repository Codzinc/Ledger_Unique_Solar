...
import { MoreVertical, Eye, Edit, Trash2, Plus, Search, DollarSign, Users, Calendar } from 'lucide-react';
...
const SalaryListing = ({
  ...
  // Filter salaries by search term and date
            ...
            <table className="w-full">
              <thead className="bg-[#181829] sticky top-0 z-10">
                <tr className="text-white">
                  ...
                  <th className="px-6 py-4 text-left text-xs font-medium uppercase tracking-wider min-w-[100px]">Date</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredSalaries.map((salary) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-[#181829]">
                      <span className=" px-2 py-1 rounded-full text-xs ">{new Date(salary.date).toLocaleDateString()}</span>
                    </td>
